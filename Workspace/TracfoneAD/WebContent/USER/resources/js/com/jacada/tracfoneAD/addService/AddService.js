...
Ext.define('Jacada.user.com.jacada.tracfoneAD.addService.AddService', {
    extend: 'Jacada.user.com.jacada.tracfoneAD.baseComponents.BaseView',
    xtype: 'addService',
    initComponent: function () {
        $W().setTabTitle("Add Service", "");
        var me = this;
        Ext.applyIf(me, {
            name: 'addService',
            cls: 'unableUnableCls',
                ...
                */
                {
                    ...
                    items: [
                        {
                            xtype: 'component',
                            itemId: 'addServiceJasFrame',
                            columnWidth: 0.4,
                            autoEl: {
                                tag: 'iframe',
                                name: 'addServiceJasFrame',
                                src: '',
    ...
    listeners: {
        afterrender: function () {
            var me = this;
            me.down('#addServiceJasFrame').getEl().set({
                'src': managers['jasHandler'].getAddServiceMenuUrl()
            });
        }
    },
