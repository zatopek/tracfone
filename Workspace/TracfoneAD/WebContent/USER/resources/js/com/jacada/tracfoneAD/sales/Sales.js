...
Ext.define('Jacada.user.com.jacada.tracfoneAD.sales.Sales', {
    ...
    listeners: {
        afterrender: function () {
            var me = this;
            me.down('#salesJasFrame').getEl().set({
                'src': managers['jasHandler'].getSalesMenuUrl()
            });
        }
    },
