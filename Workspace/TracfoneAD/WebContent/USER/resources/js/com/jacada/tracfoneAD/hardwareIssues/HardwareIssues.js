...
Ext.define('Jacada.user.com.jacada.tracfoneAD.hardwareIssues.HardwareIssues', {
    extend: 'Jacada.user.com.jacada.tracfoneAD.baseComponents.BaseView',
    xtype: 'troubleShooting',
    initComponent: function () {
        $W().setTabTitle("HardwareIssues", "");
        var me = this;
        Ext.applyIf(me, {
                ...
                */
                {
                    ...
                    items: [
                        {
                            xtype: 'component',
                            itemId: 'hardwareIssuesJasFrame',
                            columnWidth: 0.4,
                            autoEl: {
                                tag: 'iframe',
                                name: 'hardwareIssuesJasFrame',
                                src: '',
    ...
    listeners: {
        afterrender: function () {
            var me = this;
            me.down('#hardwareIssuesJasFrame').getEl().set({
                'src': managers['jasHandler'].getHardwareIssuesMenuUrl()
            });
        }
    },
