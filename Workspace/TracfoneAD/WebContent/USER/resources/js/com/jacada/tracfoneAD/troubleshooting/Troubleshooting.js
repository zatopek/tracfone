...
Ext.define('Jacada.user.com.jacada.tracfoneAD.troubleshooting.Troubleshooting', {
    extend: 'Jacada.user.com.jacada.tracfoneAD.baseComponents.BaseView',
    xtype: 'troubleShooting',
    initComponent: function () {
        $W().setTabTitle("Troubleshooting", "");
        var me = this;
        Ext.applyIf(me, {
                ...
                */
                {
                    ...
                    items: [
                        {
                            xtype: 'component',
                            itemId: 'troubleshootingJasFrame',
                            columnWidth: 0.4,
                            autoEl: {
                                tag: 'iframe',
                                name: 'troubleshootingJasFrame',
                                src: '',
    ...
    listeners: {
        afterrender: function () {
            var me = this;
            me.down('#troubleshootingJasFrame').getEl().set({
                'src': managers['jasHandler'].getTroubleshootingMenuUrl()
            });
        }
    },
