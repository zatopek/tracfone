...
Ext.define('Jacada.user.com.jacada.tracfoneAD.account.Account', {
    extend: 'Jacada.user.com.jacada.tracfoneAD.baseComponents.BaseView',
    xtype: 'accounts',
    initComponent: function () {
        $W().setTabTitle("Accounts", "");
        var me = this;
        Ext.applyIf(me, {
            name: 'accounts',
            cls: 'unableUnableCls',
                ...
                */
                {
                    ...
                    items: [
                        {
                            xtype: 'component',
                            itemId: 'accountsJasFrame',
                            columnWidth: 0.4,
                            autoEl: {
                                tag: 'iframe',
                                name: 'accountsJasFrame',
                                src: '',
    ...
    listeners: {
        afterrender: function () {
            var me = this;
            me.down('#accountsJasFrame').getEl().set({
                'src': managers['jasHandler'].getAccountMenuUrl()
            });
        }
    },
