...
Ext.define('Jacada.user.com.jacada.tracfoneAD.solutions.Solutions', {
    extend: 'Jacada.user.com.jacada.tracfoneAD.baseComponents.BaseView',
    xtype: 'solutions',
    initComponent: function () {
        $W().setTabTitle("Solutions", "");
        var me = this;
        Ext.applyIf(me, {
            name: 'solutions',
            cls: 'unableUnableCls',
                ...
                */
                {
                    ...
                    items: [
                        {
                            xtype: 'component',
                            itemId: 'solutionsJasFrame',
                            columnWidth: 0.4,
                            autoEl: {
                                tag: 'iframe',
                                name: 'solutionsJasFrame',
                                src: '',
    ...
    listeners: {
        afterrender: function () {
            var me = this;
            me.down('#solutionsJasFrame').getEl().set({
                'src': managers['jasHandler'].getSolutionsMenuUrl()
            });
        }
    },
