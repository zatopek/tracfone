...
Ext.define('Jacada.user.com.jacada.tracfoneAD.phoneFunctionality.PhoneFunctionality', {
    extend: 'Jacada.user.com.jacada.tracfoneAD.baseComponents.BaseView',
    xtype: 'troubleShooting',
    initComponent: function () {
        $W().setTabTitle("Phone Functionality", "");
        var me = this;
        Ext.applyIf(me, {
            name: 'phoneFunctionality',
            cls: 'unableUnableCls',
            items: [
                /*
                ...
                */
                {
                    ...
                    items: [
                        {
                            xtype: 'component',
                            itemId: 'phoneFunctionalityJasFrame',
                            columnWidth: 0.4,
                            autoEl: {
                                tag: 'iframe',
                                name: 'phoneFunctionalityJasFrame',
                                src: '',
    ...
    listeners: {
        afterrender: function () {
            var me = this;
            me.down('#phoneFunctionalityJasFrame').getEl().set({
                'src': managers['jasHandler'].getPhoneFunctionalityMenuUrl()
            });
        }
    },
