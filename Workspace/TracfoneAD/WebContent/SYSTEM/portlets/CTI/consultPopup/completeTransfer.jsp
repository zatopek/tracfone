...
<netui:html>
    ...
    <body  class="ctiPopup">
        <script language="JavaScript" type="text/javascript"> 
            createButton('TransferCompleteBtn', 'javascript:$W().cti.doCompleteTransferAction(\'completeTransfer\');') ;
            createButton('TransferReturnBtn', 'javascript:$W().cti.doCompleteTransferAction(\'returnCall\');') ;
        </script>
        <jacada:if expr="${pageFlow.softReturnEnabled}">
        <script language="JavaScript" type="text/javascript"> 
            createButton('WarmTransferToggleToCustomerBtn', 'javascript:$W().cti.doCompleteTransferAction(\'toggleToCustomer\');$W().cti.popup.hide();') ;
        </script>
	   </jacada:if>
