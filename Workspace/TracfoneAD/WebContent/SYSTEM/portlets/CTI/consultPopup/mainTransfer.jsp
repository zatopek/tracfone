...
<netui:html>
    ...
    <body class="ctiPopup">
        <script language="JavaScript" type="text/javascript"> 
        	createButton('TransferStandardBtn', 'javascript:$W().cti.doSelectedTransfer(\'Standard\');') ;
            createButton('TransferConnectBtn', 'javascript:$W().cti.doSelectedTransfer(\'Connect\');') ;
        </script>
