...
<netui:html>
    ...
    <body class="ctiPopup">
       ...
       <script language="JavaScript" type="text/javascript"> 
            createButton('ConsultJoinBtn', 'javascript:$W().cti.doConferenceAction(\'joinCall\');$W().cti.popup.hide();') ;
            createButton('ConsultReturnBtn', 'javascript:$W().cti.doConferenceAction(\'returnCall\');$W().cti.popup.hide();') ;
        </script> 
        <jacada:if expr="${pageFlow.softReturnEnabled}">
        <script language="JavaScript" type="text/javascript"> 
            createButton('ConsultToggleToCustomerBtn', 'javascript:$W().cti.doConferenceAction(\'toggleToCustomer\');$W().cti.popup.hide();') ;
        </script>
	   </jacada:if>
        <jacada:if expr="${pageFlow.allowTransferFromConsultPopup}">
        <script language="JavaScript" type="text/javascript"> 
            createButton('ConsultTransferBtn', 'javascript:$W().cti.doConferenceAction(\'transferCallFromConsult\');$W().cti.popup.hide();') ;
        </script>
	   </jacada:if>
