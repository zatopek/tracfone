 ...
 *
 * Jacada note:  modified this comment to avoid errors when running in https mode (bug ws-1027):
 * the file to include is simile-ajax-api.js from the mit site by using a <script> tag.
 *    
 *
 *==================================================
 */
